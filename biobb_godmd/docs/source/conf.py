...
htmlhelp_basename = 'biobb_godmd_doc'
...
latex_documents = [
    (master_doc, 'biobb_godmd.tex', u'biobb_godmd Documentation',
...
man_pages = [
    (master_doc, 'biobb_godmd', u'biobb_godmd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_godmd', u'biobb_godmd Documentation',
     author, 'biobb_godmd', 'biobb_godmd template building block',
     'Miscellaneous'),
]
